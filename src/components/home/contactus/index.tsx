    ...
    <div id="contact" className=" py-[48px] bg-skyblue">
      ...
      <div className="mt-[28px] relative h-[500px] lg:h-[880px] flex flex-col  items-center lg:px-[123px] ">
        ...
        <div className="bg-white w-[95%] mx-auto absolute top-24 lg:top-[400px] flex shadow-md lg:w-[900px]">
          {/* Form */}
          <form className="w-[60%] py-[24px] px-[10px] lg:px-[36px]">
            <div className="px-[10px] w-full">
              ...
              <div className="mt-[16px]">
                <input
                  ...
                  className="px-[24px] py-[16px] w-full border rounded-[10px] text-[12px] lg:text-[14px]"
                />
              </div>
              <div className="mt-[16px]">
                <input
              ...
              <div className="lg:flex lg:items-center lg:gap-[20px]">
                <Button text="Submit" className=" text-white mt-[16px]" />
